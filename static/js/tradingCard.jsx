...
function TradingCardContainer() {
  ...
  // and make a TradingCard component
    // console.log(card['name'], card['imgUrl'], card['skill'])
    return ( "success" );
      ...
      // </div>
        // return card.name, card.imgUrl, card.skill
      // });
...
// ReactDOM.render(
//   <TradingCard name="Mobster" skill="Peeling bananas" imgUrl="/static/img/off-by-one.jpeg" />,
//   document.querySelector('#off-by-one'),
// );

// ReactDOM.render(
//   <TradingCard name="Mr MelonHead" skill="skipping stones" imgUrl="/static/img/seedpy.jpeg" />,
